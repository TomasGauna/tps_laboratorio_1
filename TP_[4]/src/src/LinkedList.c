...
static Node* getNode(LinkedList* this, int nodeIndex)
{
	...
	{
		pNode = this->pFirstNode;//asigo al pNode la primer direccion de memoria

		for(int i = 0; i < nodeIndex; i++)
		{
			pNode = pNode->pNextNode;//recorro hasta el index asignando al pNode, la siguiente direccion de memoria
		}
	}
